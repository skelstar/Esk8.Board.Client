...
State state_trip_page(
    ...
    [] {
      ...
      tft.fillScreen(TFT_BLACK);
      lcd_message_middle(MC_DATUM, "trip page", 2);
    },
    NULL,
    NULL);
//-------------------------------
...
void TRIGGER(uint8_t x)
{
  switch (x)
  {
    case EV_SERVER_CONNECTED: Serial.printf("trigger: EV_SERVER_CONNECTED\n"); break;
    case EV_SERVER_DISCONNECTED: Serial.printf("trigger: EV_SERVER_DISCONNECTED\n"); break;
    case EV_MOVING: Serial.printf("trigger: EV_MOVING\n"); break;
    case EV_STOPPED_MOVING: Serial.printf("trigger: EV_STOPPED_MOVING\n"); break;
    case EV_BUTTON_CLICK: Serial.printf("trigger: EV_BUTTON_CLICK\n"); break;
