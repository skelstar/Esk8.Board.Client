...
myPushButton button(TTGO_BUTTON_1, PULLUP, OFFSTATE, [](int eventCode, int eventPin, int eventParam)
  {
...
void buzzerBuzz()
{
  for (int i = 0; i < 100; i++)
  {
    digitalWrite(TTGO_BUTTON_1, HIGH);
    delay(1);
    digitalWrite(TTGO_BUTTON_1, LOW);
    delay(1);
  }
}
